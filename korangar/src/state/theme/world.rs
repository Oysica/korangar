...
impl Default for StatusBarTheme {
    fn default() -> Self {
        Self {
            ...
            player_bar_width: 55.0,
            enemy_bar_width: 45.0,
            health_height: 4.0,
            enemy_health_height: 4.0,
            spell_point_height: 2.0,
            activity_point_height: 2.0,
            border_size: ScreenSize { width: 1.0, height: 1.0 },
            gap: 1.0,
        }
    }
}
