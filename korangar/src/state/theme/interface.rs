...
impl InterfaceTheme {
    ...
    fn default_menu() -> Self {
        Self {
            window: WindowTheme {
                title_color: Color::rgb_u8(240, 200, 130),
                hovered_title_color: Color::rgb_u8(255, 220, 150),
                background_color: Color::rgba_u8(22, 22, 28, 245),
                highlight_color: Color::rgb_u8(255, 160, 60),
                shadow_color: Color::rgba_u8(0, 0, 0, 140),
                shadow_padding: ShadowPadding::diagonal(6.0, 14.0),
                gaps: 16.0,
                border: 22.0,
                corner_diameter: CornerDiameter::uniform(16.0),
                close_button_size: ScreenSize { width: 36.0, height: 28.0 },
                close_button_corner_diameter: CornerDiameter::uniform(10.0),
                minimum_width: 300.0,
                maximum_width: 600.0,
                minimum_height: 50.0,
            ...
            button: ButtonTheme {
                background_color: Color::rgba_u8(60, 65, 78, 255),
                foreground_color: Color::monochrome_u8(210),
                highlight_color: Color::rgb_u8(255, 160, 60),
                hovered_background_color: Color::rgba_u8(95, 105, 125, 255),
                hovered_foreground_color: Color::monochrome_u8(245),
                disabled_background_color: Color::rgba_u8(45, 48, 55, 255),
                disabled_foreground_color: Color::monochrome_u8(110),
                shadow_color: Color::rgba_u8(0, 0, 0, 120),
                shadow_padding: ShadowPadding::diagonal(1.0, 3.0),
                height: 32.0,
            ...
            state_button: StateButtonTheme {
                background_color: Color::rgba_u8(50, 54, 64, 255),
                foreground_color: Color::monochrome_u8(200),
                highlight_color: Color::rgb_u8(255, 160, 60),
                hovered_background_color: Color::rgba_u8(80, 90, 110, 255),
                hovered_foreground_color: Color::monochrome_u8(240),
                disabled_background_color: Color::monochrome_u8(40),
                disabled_foreground_color: Color::monochrome_u8(100),
                checkbox_color: Color::rgb_u8(255, 130, 110),
                hovered_checkbox_color: Color::rgb_u8(255, 165, 130),
                disabled_checkbox_color: Color::monochrome_u8(150),
                shadow_color: Color::rgba_u8(0, 0, 0, 100),
                shadow_padding: ShadowPadding::diagonal(1.0, 3.0),
                height: 22.0,
                corner_diameter: CornerDiameter::uniform(6.0),
                font_size: FontSize(16.0),
                horizontal_alignment: HorizontalAlignment::Left { offset: 36.0, border: 3.0 },
                vertical_alignment: VerticalAlignment::Center { offset: 0.0 },
                overflow_behavior: OverflowBehavior::Shrink,
            },
            text_box: TextBoxTheme {
                background_color: Color::rgba_u8(35, 38, 46, 255),
                foreground_color: Color::monochrome_u8(190),
                highlight_color: Color::rgb_u8(255, 160, 60),
                hovered_background_color: Color::rgba_u8(50, 55, 66, 255),
                hovered_foreground_color: Color::monochrome_u8(220),
                focused_background_color: Color::rgba_u8(68, 75, 90, 255),
                focused_foreground_color: Color::monochrome_u8(255),
                ghost_foreground_color: Color::monochrome_u8(95),
                ...
                font_size: FontSize(16.0),
                horizontal_alignment: HorizontalAlignment::Left { offset: 12.0, border: 5.0 },
                vertical_alignment: VerticalAlignment::Center { offset: -2.0 },
                overflow_behavior: OverflowBehavior::LineBreak,
            },
